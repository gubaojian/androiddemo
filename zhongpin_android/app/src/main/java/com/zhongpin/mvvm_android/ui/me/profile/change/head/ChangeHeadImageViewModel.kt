...
class ChangeHeadImageViewModel  : BaseViewModel<ChangeHeadImageRepository>() {
    ...
    fun updateUserInfo(parameters:HashMap<String,Any>) : MutableLiveData<BaseResponse<Boolean>> {
        val mLiveData: MutableLiveData<BaseResponse<Boolean>> = MutableLiveData()
        initiateRequest({
            mLiveData.value = mRepository.updateUserInfo(parameters);
        }, loadState)
        return mLiveData
    }
