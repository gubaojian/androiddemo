...
class ChangeHeadImageRepository(private val loadState: MutableLiveData<State>): BaseRepository() {
    ...
    suspend fun updateUserInfo(parameters:HashMap<String,Any>): BaseResponse<Boolean> {
        return apiService.updateUserInfo(parameters).requireLogin()
    }
