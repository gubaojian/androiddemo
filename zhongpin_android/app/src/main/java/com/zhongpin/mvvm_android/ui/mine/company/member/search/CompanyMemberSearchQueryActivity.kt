package com.zhongpin.mvvm_android.ui.mine.company.member.search
...
@EventBusRegister
class CompanyMemberSearchQueryActivity : BaseVMActivity<CompanyMemberSearchQueryViewModel>() {


    private val mmkv = MMKV.defaultMMKV()
    private val searchHistoryKey = "memberSearchHistoryKey"

    private lateinit var mBinding: ActivityCompanyMemberSearchQueryBinding;
    ...
    override fun createContentViewByBinding(inflater: LayoutInflater, container: ViewGroup?): View {
        mBinding = ActivityCompanyMemberSearchQueryBinding.inflate(layoutInflater, container, false)
    ...
    fun searchOrderByKeyword(searchInput:String) {
        ...
        val query = MemberItemSearchQuery(
            inputText = searchInput
        );
        EventBusUtils.postEvent(MemberItemSearchQueryChangeEvent(query = query))
        if (searchQuery == null) {
            val intent = Intent(this@CompanyMemberSearchQueryActivity, CompanyMemberListActivity::class.java)
    ...
    fun showHistory(historyList: MutableList<String>) {
        if (historyList.isEmpty()) {
            ...
            historyList.forEach { outIt ->
                val binding = ViewHistoryLabelItemBinding.inflate(LayoutInflater.from(this@CompanyMemberSearchQueryActivity))
