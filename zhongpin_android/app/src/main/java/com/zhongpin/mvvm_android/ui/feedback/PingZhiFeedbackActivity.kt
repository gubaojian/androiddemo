...
import com.zhilianshidai.pindan.app.databinding.ActivityPingzhiFeedbackBinding
...
@EventBusRegister
class PingZhiFeedbackActivity : BaseVMActivity<PingZhiFeedbackViewModel>() {


    private lateinit var mBinding: ActivityPingzhiFeedbackBinding;
    ...
    override fun createContentViewByBinding(inflater: LayoutInflater, container: ViewGroup?): View {
        mBinding = ActivityPingzhiFeedbackBinding.inflate(layoutInflater, container, false)
    ...
    override fun initView() {
       ...
       // BannerUtils.setBannerRound(mBinding.yingYeZhiZhao, SizeUtils.dp2px(8.0f).toFloat())
        ...
        mBinding.chooseFeedbackTypeContainer.setOnClickListener {
            ...
            val picker = OptionPicker(this@PingZhiFeedbackActivity)
    ...
    fun showDeleteConfirmDialog() {
        val builder = AlertDialog.Builder(this@PingZhiFeedbackActivity)
    ...
    fun showTipDialogFrom() {
        ...
        builder.setMessage("您填写的申诉信息已提交，\n" +
                "请等待人工处理。\n" +
                "如需查看申诉详情，可在“我的-我的申诉”查看。")
