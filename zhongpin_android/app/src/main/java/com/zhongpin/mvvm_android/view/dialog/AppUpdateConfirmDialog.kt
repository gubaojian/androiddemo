...
import com.zhilianshidai.pindan.app.databinding.DialogAppUpdateConfirmBinding
import com.zhilianshidai.pindan.app.databinding.DialogConfirmBinding
import com.zhongpin.lib_base.ktx.gone

class AppUpdateConfirmDialog @JvmOverloads constructor(
    ...
    private lateinit  var mBinding: DialogAppUpdateConfirmBinding;


    init {
        mBinding = DialogAppUpdateConfirmBinding.inflate(LayoutInflater.from(context))
