        ...
        with(holder.binding){
            ...
            getRoot().click {
                item.expireDate?.let {
                    ...
                    listener.onExpireDateClick(position, it)
