...
import com.longbridge.mdtrade.adapter.TradeOptionDateLineAdapter
import com.longbridge.mdtrade.adapter.TradeOptionDateLineAdapter.OnExpireDateClickListener
 ...
 *  日期滚动view 
 */
open class TradeOptionDateScrollView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    private val adapter: TradeOptionDateLineAdapter by lazy { createDateLineAdapter() }
    ...
    private fun createCollectionView(): RecyclerView {
        ...
        return configureRecyclerViewCommon(
            ...
            adapter = this@TradeOptionDateScrollView.adapter,
    ...
    private fun createDateLineAdapter(): TradeOptionDateLineAdapter {
        val adapter = TradeOptionDateLineAdapter(
            dataSource as MutableList<ConvertDateLine.OptionDate>,
            object : OnExpireDateClickListener {
